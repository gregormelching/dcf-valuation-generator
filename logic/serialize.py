from valuation import dcf_value, sensitivity_grid, sensitivity_table, nwc_scenario, implied_assumptions, plausible_ceiling, implied_horizon, WACC_OFFSETS, TERMINAL_GROWTHS, MARGIN_BASES, NWC_OFFSETS
...
def serialize_company(symbol: str, start_year: int, years: int, freq: str, n: int, as_of: str | None = None):
    ...
    blocks["Assumptions"] = [
        ...
        {"Label": "EBIT-Startmarge", "Value": wacc["EBIT_Margin_Start"],  "Unit": "pct", "Source": wacc["Margin_Start_Source"]},
        {"Label": "EBIT-Zielmarge",  "Value": wacc["EBIT_Margin_Target"], "Unit": "pct", "Source": wacc["Margin_Base"]},
        ...
        {"Label": "Steuersatz",      "Value": tax["Effective_Tax_Rate"],  "Unit": "pct", "Source": tax["Source"]},
    ]
